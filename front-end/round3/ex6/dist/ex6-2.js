...
const output = input !== null && input !== void 0 ? input : defaultValue;
console.log(output); // 출력: "default"
const numberInput = 0;
const numberDefault = 5;
const numberOutput = numberInput !== null && numberInput !== void 0 ? numberInput : numberDefault;
console.log(numberOutput); // 출력: 0
//# sourceMappingURL=ex6-2.js.map